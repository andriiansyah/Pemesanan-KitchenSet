            ...
            <div class="col border">
                ...
                <?php
                        ...
                        <div class="table-responsive">
                            ...
                            <!--  -->
                                    <?php
                                        ...
                                        //     {
                                        //         ?>
                                                 <?php //echo $alternatif[$index_kitchen][$j] . "<br>"; ?>
                    ...
                    <?php
                        ...
                        // $result = mysqli_query($conn, "SELECT * FROM tb_rating");
                        // while($data = mysqli_fetch_array($result))
                        // {
                        ...
                        //     echo $id_rating . "<br>" . $id_kitchen . "<br>" . $id_pelanggan . "<br>" . $rating . "<br>";
